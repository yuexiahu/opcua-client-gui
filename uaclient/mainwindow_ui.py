...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("uaclient\\../network.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.treeContainer = QtWidgets.QWidget(parent=self.splitter)
        self.treeContainer.setObjectName("treeContainer")
        self.treeContainerLayout = QtWidgets.QVBoxLayout(self.treeContainer)
        self.treeContainerLayout.setContentsMargins(0, 0, 0, 0)
        self.treeContainerLayout.setSpacing(2)
        self.treeContainerLayout.setObjectName("treeContainerLayout")
        self.treeFilterRow = QtWidgets.QWidget(parent=self.treeContainer)
        self.treeFilterRow.setObjectName("treeFilterRow")
        self.treeFilterLayout = QtWidgets.QHBoxLayout(self.treeFilterRow)
        self.treeFilterLayout.setContentsMargins(0, 0, 0, 0)
        self.treeFilterLayout.setSpacing(2)
        self.treeFilterLayout.setObjectName("treeFilterLayout")
        self.filterDisplayName = QtWidgets.QLineEdit(parent=self.treeFilterRow)
        self.filterDisplayName.setClearButtonEnabled(True)
        self.filterDisplayName.setObjectName("filterDisplayName")
        self.treeFilterLayout.addWidget(self.filterDisplayName)
        self.filterBrowseName = QtWidgets.QLineEdit(parent=self.treeFilterRow)
        self.filterBrowseName.setClearButtonEnabled(True)
        self.filterBrowseName.setObjectName("filterBrowseName")
        self.treeFilterLayout.addWidget(self.filterBrowseName)
        self.filterNodeId = QtWidgets.QLineEdit(parent=self.treeFilterRow)
        self.filterNodeId.setClearButtonEnabled(True)
        self.filterNodeId.setObjectName("filterNodeId")
        self.treeFilterLayout.addWidget(self.filterNodeId)
        self.treeContainerLayout.addWidget(self.treeFilterRow)
        self.treeView = QtWidgets.QTreeView(parent=self.treeContainer)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeView.sizePolicy().hasHeightForWidth())
        self.treeView.setSizePolicy(sizePolicy)
        self.treeView.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.treeView.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.ActionsContextMenu)
        ...
        self.treeContainerLayout.addWidget(self.treeView)
        self.gridLayout_2.addWidget(self.splitter, 0, 0, 1, 1)
        MainWindow.setCentralWidget(self.centralWidget)
        self.menuBar = QtWidgets.QMenuBar(parent=MainWindow)
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 922, 24))
        self.menuBar.setObjectName("menuBar")
        self.menuOPC_UA_Client = QtWidgets.QMenu(parent=self.menuBar)
        ...
        self.attrDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.attrView = QtWidgets.QTreeView(parent=self.dockWidgetContents)
        self.attrView.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.attrView.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.attrView.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.AllEditTriggers)
        self.attrView.setProperty("showDropIndicator", False)
        self.attrView.setTextElideMode(QtCore.Qt.TextElideMode.ElideNone)
        ...
        self.attrRefreshButton = QtWidgets.QPushButton(parent=self.dockWidgetContents)
        ...
        self.addrDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.addrDockWidget.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.NoDockWidgetFeatures)
        self.addrDockWidget.setAllowedAreas(QtCore.Qt.DockWidgetArea.TopDockWidgetArea)
        ...
        self.connectButton = QtWidgets.QPushButton(parent=self.dockWidgetContents_2)
        ...
        self.connectButton.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.connectButton.setObjectName("connectButton")
        self.gridLayout.addWidget(self.connectButton, 1, 4, 1, 1)
        self.disconnectButton = QtWidgets.QPushButton(parent=self.dockWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.disconnectButton.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.disconnectButton.setObjectName("disconnectButton")
        self.gridLayout.addWidget(self.disconnectButton, 1, 5, 1, 1)
        self.addrComboBox = QtWidgets.QComboBox(parent=self.dockWidgetContents_2)
        ...
        self.addrComboBox.setInsertPolicy(QtWidgets.QComboBox.InsertPolicy.InsertAtTop)
        self.addrComboBox.setObjectName("addrComboBox")
        self.gridLayout.addWidget(self.addrComboBox, 1, 2, 1, 2)
        ...
        self.subDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.subView = QtWidgets.QTableView(parent=self.dockWidgetContents_3)
        self.subView.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.subView.setAcceptDrops(True)
        self.subView.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.subView.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.subView.setTabKeyNavigation(False)
        self.subView.setDragDropOverwriteMode(False)
        self.subView.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DropOnly)
        ...
        self.refDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.refView = QtWidgets.QTableView(parent=self.dockWidgetContents_4)
        self.refView.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.refView.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.evDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.evView = QtWidgets.QListView(parent=self.dockWidgetContents_5)
        self.evView.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.evView.setAcceptDrops(True)
        self.evView.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.evView.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DropOnly)
        ...
        self.logDockWidget_2 = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.logTextEdit = QtWidgets.QTextEdit(parent=self.dockWidgetContents_7)
        self.logTextEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.graphDockWidget = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.labelNumberOfPoints = QtWidgets.QLabel(parent=self.dockWidgetContents_6)
        self.labelNumberOfPoints.setObjectName("labelNumberOfPoints")
        self.horizontalLayout.addWidget(self.labelNumberOfPoints)
        self.spinBoxNumberOfPoints = QtWidgets.QSpinBox(parent=self.dockWidgetContents_6)
        ...
        self.labelIntervall = QtWidgets.QLabel(parent=self.dockWidgetContents_6)
        self.labelIntervall.setObjectName("labelIntervall")
        self.horizontalLayout.addWidget(self.labelIntervall)
        self.spinBoxIntervall = QtWidgets.QSpinBox(parent=self.dockWidgetContents_6)
        ...
        self.buttonApply = QtWidgets.QPushButton(parent=self.dockWidgetContents_6)
        ...
        self.actionSubscribeDataChange = QtGui.QAction(parent=MainWindow)
        self.actionSubscribeDataChange.setObjectName("actionSubscribeDataChange")
        self.actionUnsubscribeDataChange = QtGui.QAction(parent=MainWindow)
        self.actionUnsubscribeDataChange.setObjectName("actionUnsubscribeDataChange")
        self.actionSubscribeEvent = QtGui.QAction(parent=MainWindow)
        self.actionSubscribeEvent.setObjectName("actionSubscribeEvent")
        self.actionUnsubscribeEvents = QtGui.QAction(parent=MainWindow)
        self.actionUnsubscribeEvents.setObjectName("actionUnsubscribeEvents")
        self.actionCopyPath = QtGui.QAction(parent=MainWindow)
        self.actionCopyPath.setObjectName("actionCopyPath")
        self.actionCopyNodeId = QtGui.QAction(parent=MainWindow)
        self.actionCopyNodeId.setObjectName("actionCopyNodeId")
        self.actionExpandAll = QtGui.QAction(parent=MainWindow)
        self.actionExpandAll.setObjectName("actionExpandAll")
        self.actionAddToGraph = QtGui.QAction(parent=MainWindow)
        self.actionAddToGraph.setObjectName("actionAddToGraph")
        self.actionRemoveFromGraph = QtGui.QAction(parent=MainWindow)
        self.actionRemoveFromGraph.setObjectName("actionRemoveFromGraph")
        self.actionCall = QtGui.QAction(parent=MainWindow)
        ...
        self.actionClient_Application_Certificate = QtGui.QAction(parent=MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filterDisplayName.setPlaceholderText(_translate("MainWindow", "DisplayName"))
        self.filterBrowseName.setPlaceholderText(_translate("MainWindow", "BrowseName"))
        self.filterNodeId.setPlaceholderText(_translate("MainWindow", "NodeId"))
        ...
        self.actionExpandAll.setText(_translate("MainWindow", "Expand &All"))
        self.actionExpandAll.setToolTip(_translate("MainWindow", "Recursively expand all children of this Object node"))
